    ...
    <div className="px-6 py-6 pb-12 max-w-7xl mx-auto space-y-5">
      ...
      >
        ...
        <div className="flex flex-col gap-2 relative z-10 min-w-[180px]">
          <button className="w-full bg-primary text-white py-2.5 rounded-xl font-bold shadow hover:bg-primary-container transition-all text-sm">
            Move to Interview
          </button>
          <div className="flex gap-2">
            <button className="flex-1 bg-surface border border-outline-variant py-2 rounded-xl font-bold text-on-surface hover:bg-surface-container transition-all text-sm">
              Message
            </button>
          </div>
        </div>
